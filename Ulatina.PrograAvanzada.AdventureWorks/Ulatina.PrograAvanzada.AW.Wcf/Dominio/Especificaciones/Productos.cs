...
namespace Ulatina.PrograAvanzada.AW.Wcf.Especificaciones
{
  ...
  //      //// Consulta A
        ...
        //    var lasSalesOrden = ElRepositorio.RangoDeFechaDeLaOrden(_fecha);
        ...
        //{
        //    var ElRepositorio = new Repositorio.SalesOrderHeader();
        //    var lasSalesOrden = ElRepositorio.RangoDeTotal(_total);
        //    return lasSalesOrden;
        ...
        //{
        //    var ElRepositorio = new Repositorio.SalesOrderHeader();
        //    var lasSalesOrden = ElRepositorio.ListaFacturaPorDetalleYDescuento(_descuento);
        //    return lasSalesOrden;
        //}
        ...
        //{
        //    var ElRepositorio = new Repositorio.SalesOrderHeader();
        //    var lasSalesOrden = ElRepositorio.ListaDeFacturasPorRango(_detalle);
        //    return lasSalesOrden;
        ...
        //{
        //    var ElRepositorio = new Repositorio.SalesOrderHeader();
        //    var lasSalesOrden = ElRepositorio.ListaGeneroEspecificoVendedor(_genero);
        //    return lasSalesOrden;
        //}
        ...
        //{
        //    var ElRepositorio = new Repositorio.SalesOrderHeader();
        //    var lasSalesOrden = ElRepositorio.ListaDeFacturasPorEdad(_edad);
        //    return lasSalesOrden;
        //}
        //// consulta G
        ...
        //{
        //    var ElRepositorio = new Repositorio.SalesOrderHeader();
        //    var lasSalesOrden = ElRepositorio.ListaFacturasDeVendedoresRangoAntiguedad(_fecha);
        //    return lasSalesOrden;
        //}
        //// consulta H
        ...
        //{
        //    var ElRepositorio = new Repositorio.SalesOrderHeader();
        //    var lasSalesOrden = ElRepositorio.ListaFacturasVendedoresTextoEspecificoApellidoNombre(_palabra);
        //    return lasSalesOrden;
        //}
    }
}