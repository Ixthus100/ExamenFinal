...
namespace Ulatina.PrograAvanzada.AW.Wcf.Repositorio
{
  ...
  //          var losProductos = _Contexto.Product.Join(_Contexto.ProductReview, product => product.ProductID, review => review.ProductID, (product, review) => product).ToList();
        ...
        //public IList<Model.SalesOrderHeader> RangoDeFechaDeLaOrden(DateTime _fecha)
        //{
        ...
        //{
        //    //var LosProductos = _Contexto.SalesOrderHeader.Where(p => _total == p.ListPrice).ToList();
        //    return null;
        //}
        ...
        //// consulta c
        //public IList<Model.SalesOrderHeader> ListaFacturaPorDetalleYDescuento(decimal _descuento)
        //{
        //    //var LosProductos = _Contexto.SalesOrderHeader.Include("productSubCategory").Include("ProductDeatil")
        ...
        //{
        //    //var LosProductos = _Contexto.SalesOrderHeader.Include("ProductSubCategory").Include("ProductModel").Where(p => p.ProductModel.Name.Contains(_detalle)).ToList();
        //    return null;
        //}
        ...
        //{
        //    //var LosProductos = _Contexto.SalesOrderHeader.Where(p => p.Name.Contains(_genero)).ToList();
        //    ////var LosProductos = _Contexto.Employee.Include("Employee").Where(p => p.Person.PersonType.)
        //    return null;
        //}
        //// consulta f 
        //public IList<Model.SalesOrderHeader> ListaDeFacturasPorEdad(decimal _edad)
        //{
        ...
        //}
        //// consulta G
        //public IList<Model.SalesOrderHeader> ListaFacturasDeVendedoresRangoAntiguedad(DateTime fecha)
        //{
